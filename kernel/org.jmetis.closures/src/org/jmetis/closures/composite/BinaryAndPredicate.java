 ...
 *
 */
public class BinaryAndPredicate<A1, A2> implements IBinaryPredicate<A1, A2> {
	 ...
	 * 
	 */
	public BinaryAndPredicate(IBinaryPredicate<? super A1, ? super A2> firstPredicate, IBinaryPredicate<? super A1, ? super A2> secondPredicate) {
		super();
