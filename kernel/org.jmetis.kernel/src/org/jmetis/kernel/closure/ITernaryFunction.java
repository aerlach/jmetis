...
/**
 * {@code ITernaryFunction} is a function that accepts one three arguments.
 * 
 * <p>
 * Example:
 * </p>
 ...
 * @param <A3>
 *            the allowable types for the functor's third argument.
 * 
 * @author era
 */
public interface ITernaryFunction<R, A1, A2, A3> {
	 ...
	 */
	R evaluate(A1 firstArgument, A2 secondArgument, A3 thirdArgument);
