 ...
 */
package org.jmetis.observable.collection;
...
import org.jmetis.observable.IIndexedModel;
...
IIndexedModel<E> {
	...
	public E set(int index, E element) {
		E oldElement = this.observedList.set(index, element);
	...
	public E remove(int index) {
		E oldElement = this.observedList.remove(index);
		this.fireElementsChanged(index, new Object[] { oldElement },
	...
	@Override
	public void clear() {
		Object[] oldElements = this.observedList.toArray();
