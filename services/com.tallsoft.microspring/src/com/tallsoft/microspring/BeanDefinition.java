        ...
        for (BeanProperty prop : properties.values()) {
            if (prop.getType() == PropertyType.VALUE) {
                if (prop.getValue()==null) {
                    throw new BeansException("bean ["+id+"] has value property ["
                            +prop.getName()+"] which has a null value - Illegal.");
            ...
            if (prop.getType() == PropertyType.LIST) {
                ...
                if (vals==null) {
                    throw new BeansException("bean ["+id+"] has list properties ["
                            +prop.getName()+"] which are null - Illegal.");
                }
